...
//weitere Challenge, mache das selber mit den lowercase
function findByLastName(employees, lastName) {
  const searchByLastName = employees.find((employee) => employee.lastName === lastName);
...
function findByCitySubString(employees, substring) {
  const searchBySubstring = employees.find((employee) => employee.city.includes(substring));
...
function findByProfessionSubStringAndAge(employees, substring, age) {
  const searchByProfessionSubStringAndAge = employees.find((employee) => employee.profession.includes(substring) && employee.age >= age);
  return searchByProfessionSubStringAndAge;
}
